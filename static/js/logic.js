document.addEventListener("DOMContentLoaded", function() {
    const urls = {
        location1: 'http://localhost:5000/api/v1.0/start_stations',
        location2: 'http://localhost:5000/api/v1.0/end_stations',
        location3: 'http://localhost:5000/api/v1.0/top_routes',
        location4: 'http://localhost:5000/api/v1.0/stations',
    };
